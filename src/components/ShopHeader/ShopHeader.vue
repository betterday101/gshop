<template>
  <div class="shop-header">
    <nav class="shop-nav"
         :style="`background-image:url(${shopinfo.bgImg});`">
      <a class="back" @click="$router.back()">
        <i class="iconfont icon-arrow_left"/>
      </a>
    </nav>
    <div class="shop-content" @click="isShowBrife=!isShowBrife">
      ...
      <div class="header-content">
        ...
        <div class="shop-message">
          <span class="shop-message-detail">配送价格{{shopinfo.deliveryPrice}}</span>
        ...
        <p class="shop-notice ellipsis">{{shopinfo.bulletin}}</p>
      </div>
    </div>
    ...
    <transition name="sofade">
      <div class="shop-brief-modal" v-if="isShowBrife">
        <div class="brief-modal-content">
          ...
          <div class="mask-footer" @click="isShowBrife=!isShowBrife">
    ...
    <div class="activity-sheet"  v-if="isShowActivity">
      <div class="activity-sheet-content">
        <h2 class="activity-sheet-title">
          优惠活动</h2>
        <ul class="list">
          <li class="activity-item" :class="ActivityClass[support.type]" v-for="(support ,index) in shopinfo.supports" :key="index">
            <span class="content-tag">
    ...
    export default {
      ...
      data(){
        return {
          ...
          ActivityClass:["activity-green","activity-orange","activity-red"]
        }
      },
      mounted(){
...
<style lang="stylus" rel="stylesheet/stylus" scoped>
  ...
  .shop-header
    ...
    .shop-brief-modal
      ...
      color #333
      &.sofade-enter-active,.sofade-leave-active
         transition opacity  0.2s
      &.sofade-enter,.sofade-leave
          opacity 0
      .brief-modal-cover
        position absolute
        width 100%
